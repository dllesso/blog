...
<hr>
<center><em><a href="articles.php? "><img src = "img1/gl.gif"/> все     записи</a></center>
...
?>
Категория:<a href = "articles.php?categories_id=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a>
...
Категория:<a href = "article.php?categorie=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a>
