...
?>
<img src = "img1/<?php echo "$i";?>.gif"/><a href="categorie.php?categories_id=<?php echo $art_cat['id'];?>"> 
...
<p class="green"><?php echo'статья:   '. mb_substr(strip_tags($art['text']), 0, 150,'utf-8').' ...';?></p><br><br><hr>
<?php
}
?>
</div>
